...
function quizStart(){
    if(index < 20){
        ...
        optionOne.style.background = "black";
        optionTwo.style.background = "black";
        optionThree.style.background = "black";
        optionFour.style.background = "black";

        optionOne.style.boxShadow = "2px 2px rgb(00,15,00)";
        optionTwo.style.boxShadow = "2px 2px rgb(00,15,00)";
        optionThree.style.boxShadow = "2px 2px rgb(00,15,00)";
        optionFour.style.boxShadow = "2px 2px rgb(00,15,00)";
...
function answerCheck(button){
    ...
    if(chosenanswer == correctanswer){
        score += 3;
        button.style.background = "rgb(00,255,00)";
        button.style.boxShadow = "2px 2px rgb(00,240,00)";
        button.style.border = "rgb(00,255,00)";
    }
    else{
        score --;
        button.style.background = "rgb(255,00,00)";
        button.style.boxShadow = "2px 2px rgb(220,00,00)";
        button.style.border = "rgb(255,00,00)";

        let correctanswerbutton;
        if(optionOne.innerHTML.slice(3) == correctanswer){
            correctanswerbutton = optionOne;
        }
        else if(optionTwo.innerHTML.slice(3) == correctanswer){
            correctanswerbutton = optionTwo;
        }
        else if(optionThree.innerHTML.slice(3) == correctanswer){
            correctanswerbutton = optionThree;
        }
        else{
            correctanswerbutton = optionFour;
        }

        correctanswerbutton.style.background = "rgb(00,255,00)";
        correctanswerbutton.style.boxShadow = "2px 2px rgb(00,240,00)";
        correctanswerbutton.style.border = "rgb(00,255,00)";
    }
    localindex++;
...
function quizSubmit(){
    let confirmation = window.confirm("Test will be submitted!");
    if(confirmation){
        stopTime();
        localStorage.setItem("score", score);
        quizstarted = false;
